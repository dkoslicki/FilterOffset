...
|---|---|---|---|---|
| B | 0 (reference) | **0** | -- | 5 |
| G | -5.63 +/- 0.83 | **-6** | -7.60 ... -3.65 | 3 |
| R | -6.47 +/- 0.79 | **-6** | -8.35 ... -4.59 | 3 |

**k = -6.62 +/- 0.31 steps/C**, referenced at 15.08 C. Autofocus repeatability
...
| estimator | k (steps/C) |
|---|---|
| joint fit (offsets included) | -6.62 +/- 0.31 |
...
| block-mean temperature | -6.91 | -5.77 | -5.94 |
...
- **Thermal lag:** smoothing ambient temperature with tau ~ 30 min cuts residual
  ...
  not established. Physically sensible: focus follows the glass and tube, which
  lag the air.
...
|---|---|---|
| astap / hfd_median_bright | +7.7% | <0.001 |
| astap / hfd_median | +12.8% | <0.001 |
| internal / hfd_median_bright | +7.6% | <0.001 |
| internal / hfd_median | +7.8% | <0.001 |
| internal / fwhm_median | +7.3% | <0.001 |

(G shows only +1.6...+2.8%, marginal.) The finding survives everything thrown at
